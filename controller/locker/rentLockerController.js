...
function sendEmail(email, name, otp) {
  ...
  var mailOptions = {
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p>Terimakasih telah melakukan registrasi Lockify. Silakan gunakan kode OTP ini untuk menyewa locker. OTP is valid for 5 minutes</p>
...
function sendWhatsapp(phone, name, otp) {
  ...
  Terimakasih telah melakukan regristrasi Lockify.`;
...
router.post("/locker/request/rent", (req, res) => {
  ...
  if (rent) {
    ...
    console.log(
      ...
      chalk.green(`Code Rent : ${locker.OnGoing.code} to ${user.Username}`)
    );

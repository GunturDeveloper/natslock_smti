...
function sendEmail(email, name, otp) {
  ...
  var mailOptions = {
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p>Terimakasih telah melakukan registrasi Lockify. Silakan gunakan kode OTP ini untuk membuka locker. OTP is valid for 5 minutes</p>
...
router.post("/locker/request/open", (req, res) => {
  ...
  if (rent) {
    ...
    console.log(
      ...
      chalk.green(`Code Open : ${locker.OnGoing.code} to ${user.Username}`)
    );
